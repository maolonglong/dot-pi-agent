...
Add tests for realistic observable regressions, non-trivial invariants, critical boundaries, and concrete bugs; code changes or coverage gains alone do not justify new tests. Test through public behavior boundaries, avoid implementation-coupled or tautological tests, and treat coverage as a gap signal rather than proof of quality. For concurrent code, prefer deterministic coordination or controlled scheduling over sleeps.
