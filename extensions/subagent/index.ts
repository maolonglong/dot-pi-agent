/**
 * Subagent Tool - Delegate a task to a specialized subagent
 *
 * Spawns a separate `pi` process for each invocation, giving the
 * subagent an isolated context window. Available subagents are injected
 * into the system prompt as <available_subagents> on every turn.
 *
...
const SubagentParams = Type.Object({
	...
	task: Type.String({
		description:
			"The task to delegate. Must be self-contained: the subagent cannot see this conversation, so include all necessary context.",
	}),
});
...
export default function (pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		label: "Subagent",
		description:
			"Delegate a task to a specialized subagent with an isolated context window. Available subagents are listed in <available_subagents>.",
