 ...
 *
 * Agents are loaded from both the user directory (~/.pi/agent/agents)
 * and the nearest project directory (.pi/agents). Project agents
 * override user agents with the same name.
 */
